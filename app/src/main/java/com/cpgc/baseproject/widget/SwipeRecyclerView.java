...
//    }
    ...
    //    private int footerTextColor = -1;
//
//    private int footerBgColor = -1;
//
...
//    }
//
//    public int getFooterTextColor() { m
...
//    }
    ...
    public void setRefresh(final boolean hasRefresh){
            getRecyclerView().setOnTouchListener(new OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    switch (event.getAction()){
                        case MotionEvent.ACTION_DOWN:
                            ...
                            break;
                        case MotionEvent.ACTION_MOVE:
                            if(Math.abs(v.getY() - startY) >= 0){
                                getRecyclerView().requestDisallowInterceptTouchEvent(!hasRefresh);
                                return hasRefresh ? false : true;
                            }
                            break;
                    }
